...
## **6. Очереди ожидания и справедливость**

### **Организация очередей**

RWMutex поддерживает две независимые очереди:

1. **Очередь читателей** (readerSem): FIFO-очередь читателей, заблокированных из-за активного писателя
2. **Очередь писателей** (writerSem): очередь писателей, ожидающих завершения читателей

### **Политика справедливости**

RWMutex использует **читатель-ориентированную политику**:

- **Приоритет читателей**: пока есть активные читатели, новые читатели присоединяются без блокировки
- **Голодание писателей**: при постоянном потоке читателей писатель может ждать неопределенно долго
- **Отсутствие гарантий FIFO**: между читателями и писателями нет строгого порядка

### **Алгоритм пробуждения**

При разблокировке писателя:

- **Все ожидающие читатели** пробуждаются одновременно
- **Писатели** конкурируют за базовый мьютекс `w` в порядке, определяемом планировщиком
- **Новые читатели** могут "обгонять" писателей если успеют захватить блокировку до писателя
